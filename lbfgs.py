...
class LBFGS(Optimizer):
    ...
    Arguments:
       ...
       source SAGEcal -> https://github.com/nlesc-dirac/pytorch/blob/master/torch/optim/lbfgs.py 
       
    S. Yatawatta, H. Spreeuw, and F. Diblen, Improving LBFGS optimizer in PyTorch: Knowledge transfer from radio interferometric calibration to machine learning, in 2018 IEEE 14th International Conference on e-Science, Amsterdam, 2018.
    S. Yatawatta, L. De Clercq, H. Spreeuw, and F. Diblen, A Stochastic LBFGS Algorithm for Radio Interferometric Calibration, in 2nd IEEE Data Science Workshop (DSW), Minneapolis MN, 2019.
